    ...
    <article className="glass-panel mb-5 break-inside-avoid overflow-hidden rounded-2xl border border-white/5 p-4">
      <div className="mb-4 flex items-start justify-between">
        <div>
          ...
          <h3 className="mt-2 font-headline text-lg font-bold text-slate-100">{mainTitle}</h3>
      ...
      <div className="mb-4 overflow-hidden rounded-xl bg-black/35">
        {media.videoUrl ? (
          <video
      ...
      <div className="mb-5 flex items-center justify-between">
        ...
        <span className="text-sm font-bold text-slate-100">{t("velocity")} {velocity >= 0 ? "+" : ""}{velocity}</span>
      </div>
